...
if Windows:
    ...
    PATH = str(app.applicationDirPath())
    del app
...
if not os.access(PYUIC5, os.F_OK):
    msg.append("failed to find pyuic5; tried {0}".format(PYUIC5))
if not os.access(PYRCC5, os.F_OK):
    msg.append("failed to find pyrcc5; tried {0}".format(PYRCC5))
if not os.access(PYLUPDATE5, os.F_OK):
    msg.append("failed to find pylupdate5; tried {0}".format(PYLUPDATE5))
if msg:
    print("\n".join(msg))
...
mkpyqt.py v {0}. Copyright (c) 2007-9 Qtrac Ltd. All rights reserved.
